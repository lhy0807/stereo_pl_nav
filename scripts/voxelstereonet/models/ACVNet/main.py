...
parser.add_argument('--dataset', default='ds', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--datapath', default="/work/riverlab/hongyu/dataset/DS", help='data path')
parser.add_argument('--trainlist', default='/work/riverlab/hongyu/stereo_pl_nav/scripts/voxelstereonet/filenames/DS_train.txt', help='training list')
parser.add_argument('--testlist',default='/work/riverlab/hongyu/stereo_pl_nav/scripts/voxelstereonet/filenames/DS_test.txt', help='testing list')
...
parser.add_argument('--logdir',default='/work/riverlab/hongyu/stereo_pl_nav/scripts/voxelstereonet/logs/acvnet', help='the directory to save logs and checkpoints')
